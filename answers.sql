...
SELECT brands.name FROM brands WHERE brands.discontinued IS NULL;
...
SELECT m.name, m.brand_name, b.founded FROM models AS m INNER JOIN brands AS b
ON m.brand_name = b.name;
